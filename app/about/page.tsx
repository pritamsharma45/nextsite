              ...
              <div>
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  {[
                    ...
                    <div
                      key={skill}
                      className="from-primary-50 rounded-lg bg-gradient-to-r to-purple-50 px-4 py-3 text-center font-medium text-gray-900 dark:from-gray-800 dark:to-gray-700 dark:text-white"
                    >
                      {skill}
                    </div>
                  ))}
      ...
      <div className="bg-white py-20 dark:bg-gray-900">
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="text-center">
              <div className="from-primary-500 mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-r to-purple-500">
                <svg
