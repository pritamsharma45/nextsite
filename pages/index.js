      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="max-w-10xl relative mx-auto px-4 py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="mb-8">
              <span className="inline-flex items-center rounded-full bg-primary-100 px-4 py-2 text-sm font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-200">
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link
                href="/blog"
                className="group relative inline-flex items-center justify-center overflow-hidden rounded-lg bg-gradient-to-r from-primary-600 to-purple-600 px-8 py-4 text-lg font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
              >
              ...
              <Link
                href="/about"
                className="inline-flex items-center justify-center rounded-lg border-2 border-gray-300 bg-white px-8 py-4 text-lg font-semibold text-gray-700 transition-all duration-300 hover:border-primary-500 hover:bg-primary-50 hover:text-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:border-primary-400 dark:hover:bg-primary-900 dark:hover:text-primary-300"
              >
                Learn More About Me
              </Link>
            </div>
            <div className="mt-12 flex items-center justify-center space-x-8 text-sm text-gray-500 dark:text-gray-400">
              <div className="flex items-center">
                <div className="flex -space-x-2">
                  <div className="h-8 w-8 rounded-full border-2 border-white bg-gradient-to-r from-primary-400 to-purple-500"></div>
      ...
      <div className="bg-white py-20 dark:bg-gray-900">
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary-50 to-purple-50 p-8 transition-all duration-300 hover:shadow-xl dark:from-gray-800 dark:to-gray-700">
              <div className="absolute -right-4 -top-4 h-24 w-24 rounded-full bg-gradient-to-r from-primary-200 to-purple-200 opacity-20 dark:from-primary-800 dark:to-purple-800"></div>
              <div className="relative">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-r from-primary-500 to-purple-500">
                  <svg
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-50 to-pink-50 p-8 transition-all duration-300 hover:shadow-xl dark:from-gray-800 dark:to-gray-700">
              <div className="absolute -right-4 -top-4 h-24 w-24 rounded-full bg-gradient-to-r from-purple-200 to-pink-200 opacity-20 dark:from-purple-800 dark:to-pink-800"></div>
              <div className="relative">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-pink-50 to-red-50 p-8 transition-all duration-300 hover:shadow-xl dark:from-gray-800 dark:to-gray-700">
              <div className="absolute -right-4 -top-4 h-24 w-24 rounded-full bg-gradient-to-r from-pink-200 to-red-200 opacity-20 dark:from-pink-800 dark:to-red-800"></div>
              <div className="relative">
                  ...
                  <div className="space-y-3">
                    <div className="space-y-2">
                      ...
                      <h3 className="text-xl font-semibold leading-8 tracking-tight">
                        <Link
                          href={`/blog/${slug}`}
                          className="text-gray-900 group-hover:text-primary-600 dark:text-gray-100 dark:group-hover:text-primary-400"
                        >
                          {title}
                        </Link>
                      </h3>
      ...
      {projectsData.length > 0 && (
        <div className="py-12">
            ...
            {projectsData.slice(0, 3).map((project) => (
              <div key={project.title} className="group relative">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-semibold leading-8 tracking-tight text-gray-900 dark:text-gray-100">
                      <Link
                        href={project.href}
          ...
          <div className="mt-8 text-center">
            <Link
              href="/projects"
              className="inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
            >
              View All Projects
            </Link>
          </div>
                ...
                <li>
                  <div className="relative pb-8">
                    <div className="relative flex space-x-3">
                      <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-r from-primary-500 to-purple-500 ring-8 ring-white dark:ring-gray-900">
